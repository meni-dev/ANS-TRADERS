...
/// </summary>
public class CreateDebitNoteRequestValidator : AbstractValidator<CreateDebitNoteRequest>
{
    public CreateDebitNoteRequestValidator(IShopClock clock)
    {
        RuleFor(r => r.PurchaseId).NotEmpty().WithMessage("Which supplier bill are these goods going back on?");
